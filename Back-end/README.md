...
## Installation
First you have to install node environment for your computer, at here: 
```https://www.python.org/downloads/windows/``` 
Then you have to install python3(recommend 3.7) environment for your computer, at here:
```https://python.org/```
Then running the command to install the packages:
```
npm install
```
Then you have to set up environment variable, at directory `Back-end/` creating a file `.env` and set up:
```
